...
const BlogProductMain = ({id}:any) => {
  ...
  const onSubmit: SubmitHandler<FormData> = (data) => {
    ...
    formData.append('catcat_idegory_id', data.cat_id); 
              ...
              <div className="cashier-select-field mb-5">
                ...
                <div className="cashier-input-field-style">
                  <div className="single-input-field w-full">
                    <input
                      type="text"
                      defaultValue={myproduct.title_uz}
                ...
                <div className="cashier-input-field-style">
                  <div className="single-input-field w-full">
                    <input
                      ...
                      defaultValue={myproduct.title_en}
                      {...register("title_en", {
  ...
  <div className="cashier-select-field mb-5">
    ...
    <div className="cashier-input-field-style">
      <div className="single-input-field w-full">
        <input
          type="text"
          defaultValue={myproduct.title_ru}
...
<div className="lg:col-span-4 md:col-span-6 col-span-12">
  ...
  <div className="cashier-select-field mb-5">
    ...
    <div className="cashier-input-field-style">
    <div className="single-input-field w-full">
                <select {...register("cat_id")}  name="cat_id">
